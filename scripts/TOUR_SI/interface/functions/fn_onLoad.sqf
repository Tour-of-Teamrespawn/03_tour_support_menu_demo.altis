...
if ((count (TOUR_SI_core getVariable "TOUR_SI_ammo")) > 0 && ["Artillery"] call TOUR_SI_fnc_playerCheck) then
{
	_comboSupport lbAdd "Artillery";
};
if ((count (TOUR_SI_core getVariable "TOUR_SI_ASammo")) > 0 && ["Airstrike"] call TOUR_SI_fnc_playerCheck) then
{
	_comboSupport lbAdd "Airstrike";
};
if ((count (TOUR_SI_core getVariable "TOUR_SI_Helicopters")) > 0 && ["Helicopter"] call TOUR_SI_fnc_playerCheck) then
{
	_comboSupport lbAdd "Helicopter";
};
if ((count (TOUR_SI_core getVariable "TOUR_SI_Planes")) > 0 && ["Plane"] call TOUR_SI_fnc_playerCheck) then
{
