	...
	case "airstrike":
	{
										...
										
		{
			_x ctrlEnable true;
					...
					_comboType, _sliderAmountHeight, _sliderRadius];
		...
		{
			"TOUR_SI_markerAS" setMarkerSizeLocal [20, _text2 * 30];
			"TOUR_SI_markerAS" setMarkerDirLocal _text3;
			"TOUR_SI_markerAS" setMarkerPosLocal ((getMarkerPos "TOUR_SI_marker_1")getpos [(_text2 * 30) -30, _text3]);
		};
	};	
	case "helicopter":
	{
